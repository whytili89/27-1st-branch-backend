...
#     position_list = ['Backend', 'Frontend', 'Fullstack']40 
...
#         user_id     = fake.pyint(min_value=1,max_value=19),
#         user_tag_id = fake.pyint(min_value=1,max_value=19)
#     )
...
#         posting_id     = fake.pyint(min_value=1,max_value=19),
#         posting_tag_id = fake.pyint(min_value=1,max_value=19)
#     )
